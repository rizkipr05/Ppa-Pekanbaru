...
<div class="page-content">
	<div class="page-header">
		<h1 style="color:#585858">
			<i style="margin-right:7px" class="fa fa-tag"></i> Kategori Informasi
...
elseif ($_GET['alert'] == 1) { ?>
	<div class="alert alert-success">
		...
		kategori informasi baru berhasil disimpan.
		<br>
	</div>
<?php
} 
                            	...
                            	<tr>
									...
									<td width="80" class="center">
										<div class="action-buttons">
											<a data-rel="tooltip" data-placement="top" title="Ubah" style="margin-right:5px" class="blue tooltip-info" href="?module=form_kategori&form=edit&id=<?php echo $data['id_kategori']; ?>">
												<i class="ace-icon fa fa-edit bigger-130"></i>
											</a>

											<a data-rel="tooltip" data-placement="top" title="Hapus" class="red tooltip-error" href="modules/kategori/proses.php?act=delete&id=<?php echo $data['id_kategori'];?>" onclick="return confirm('Anda yakin ingin menghapus kategori <?php echo $data['nama_kategori']; ?> ?');">
