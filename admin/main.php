...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Admin Panel || Unit Perlindungan Perempuan dan Anak (PPA) Dit Reskrimum Polda  Riau</title>

		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
	    <meta name="description" content="Aplikasi Konsultasi Online pada Unit Perlindungan Perempuan dan Anak (PPA) POLRESTA Pekanbaru" />
	    <meta name="author" content="Unit PPA Dit Reskrimum Polda Riau" />
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							&copy; 2025 - Unit Perlindungan Perempuan dan Anak (PPA) POLRESTA Pekanbaru</span>					</div>
				</div>
			</div>
