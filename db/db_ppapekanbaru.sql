...
--
-- Host: localhost
-- Waktu pembuatan: 09 Jan 2026 pada 10.46
...
CREATE TABLE `tbl_jenis_konsultasi` (
...
INSERT INTO `tbl_klien` (`id_klien`, `tanggal_daftar`, `nama_klien`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `alamat`, `telepon`, `pekerjaan`, `username`, `email`, `password`) VALUES
(6, '2026-01-09 09:16:27', 'Miming', 'Pekanbaru', '2003-01-10', 'Perempuan', 'Arengka', '085768707657', 'Pelajar', 'mming.boo@gmail.com', 'mming.boo@gmail.com', '202cb962ac59075b964b07152d234b70'),
(7, '2026-01-09 09:16:27', 'Bekti Luthfiana', 'Rengat', '2005-03-26', 'Perempuan', 'Tembilahan', '085315342728', 'Pelajar', 'bektiluthfiana@gmail.com', 'bektiluthfiana@gmail.com', '202cb962ac59075b964b07152d234b70'),
(8, '2026-01-09 09:16:27', 'Hadi', 'Lampung', '2006-01-02', 'Laki-laki', 'Keritang', '0874524236483', 'Pelajar', 'hadieciiputt@gmail.com', 'hadieciiputt@gmail.com', '202cb962ac59075b964b07152d234b70'),
(9, '2026-01-09 09:16:27', 'Anggi Junica', 'Sambu', '1992-06-08', 'Perempuan', 'Tembilahab', '0982635436237', 'Guru TK', 'anggi@gmail.com', 'anggi@gmail.com', '202cb962ac59075b964b07152d234b70'),
(10, '2026-01-09 09:16:27', 'Dina', 'Tembilahan', '1990-11-10', 'Perempuan', 'Tembilahan', '0857543432566', 'IRT', 'dina@gmail.com', 'dina@gmail.com', '202cb962ac59075b964b07152d234b70'),
(11, '2026-01-09 09:16:27', 'Mery', 'Perawang', '1991-11-14', 'Perempuan', 'Sungai Slak', '0857126354625', 'Bidan', 'mery@gmail.com', 'mery@gmail.com', '202cb962ac59075b964b07152d234b70'),
(13, '2026-01-09 09:16:27', 'ssamsugi', 'Medan', '2010-12-11', 'Laki-laki', 'Keritang', '0876534435165', 'Tidak Sekolah', 'ssamsugi@gmail.com', 'ssamsugi@gmail.com', '202cb962ac59075b964b07152d234b70'),
(16, '2026-01-09 09:16:27', 'Sarah Utami', 'Bandar Jaya', '2000-05-25', 'Perempuan', 'Sungai Rumbai', '081324561424', 'mahasiswa', 'sarahutami7@gmail.com', 'sarahutami7@gmail.com', '202cb962ac59075b964b07152d234b70'),
(17, '2026-01-09 09:16:27', 'Muhammad Rizki Pratama', 'Bandar Lampung', '2005-01-26', 'Laki-laki', 'JL Sakura no 2 kec tanjung senang kel way kandis', '088276477014', 'programmer', 'rizki.qq05@gmail.com', 'rizki.qq05@gmail.com', 'dcb6103bdce4b26cfecbecd05f0a7332'),
(18, '2026-01-09 09:27:49', 'aulia', 'jepara', '2026-01-13', 'Laki-laki', 'Kuripan Wetan, Kedawung, Kec. Kuripan, Kabupaten P', '088276477014', 'jasa', 'ulik', 'ulik@gmail.com', '5e9035c8727db80f5b635f06c7e141d5');
...
(1, 'stafppa', '0192023a7bbd73250516f069df18b500', 'Staf PPA', 'Customer Service'),
(2, 'pimpinan', '0192023a7bbd73250516f069df18b500', 'Pimpinan', 'Pimpinan');
...
ALTER TABLE `tbl_informasi`
  ...
  ADD KEY `id_kategori_info` (`id_kategori`),
  ADD KEY `id_kategori_info_2` (`id_kategori`),
  ADD KEY `id_kategori` (`id_kategori`);

--
-- Indeks untuk tabel `tbl_jenis_konsultasi`
--
ALTER TABLE `tbl_jenis_konsultasi`
...
ALTER TABLE `tbl_konsultasi`
  ...
  ADD KEY `id_klien` (`id_klien`,`id_konselor`,`id_jenis`),
...
--
-- AUTO_INCREMENT untuk tabel `tbl_jenis_konsultasi`
--
ALTER TABLE `tbl_jenis_konsultasi`
...
--
ALTER TABLE `tbl_klien`
  MODIFY `id_klien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `tbl_konselor`
--
ALTER TABLE `tbl_konselor`
  MODIFY `id_konselor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
